...
# Defaults
DEFAULT_CRYPTOS = "bitcoin,ethereum,solana,boricoin,ripple,binancecoin,cardano,avalanche-2,chainlink,polygon,dogecoin,arbitrum,render-token,fetch-ai,pepe,bonk,shiba-inu,xyo,virtual-protocol,sui"
